...
/assets/img/                Static images if any (prefer the Unsplash hotlinks in data.js).
```
...
6. No lorem, no placeholder images other than the Unsplash hotlinks in data (gradient fallback on 404).
